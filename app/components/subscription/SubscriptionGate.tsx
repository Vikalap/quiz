    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <Card className="relative w-full max-w-2xl border-2 border-blue-500/50 shadow-2xl shadow-blue-500/20">
        <div className="absolute -top-4 left-1/2 -translate-x-1/2">
          <Badge className="bg-linear-to-r from-blue-600 to-cyan-600 px-4 py-1 text-sm font-bold">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Benefits */}
          <div className="rounded-lg bg-linear-to-r from-blue-600/20 to-cyan-600/20 p-6 border border-blue-500/30">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              ...
              size="lg"
              className="flex-1 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold"
            >
